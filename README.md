...
- **Phase 2f** ✅ Email MFA invite — dual-channel: email carries signed payload + commitment, OOB (SMS/voice) carries 12-word secret; `invite-email` + `join-email` CLI commands
